...
- New app logo generated for Absen Kelas.
- New GitHub/README banner image.
- Updated Tauri icon bundle for macOS, Windows, Android, and iOS icon outputs.
- App version metadata is now `0.1.5`.
